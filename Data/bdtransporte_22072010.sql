...
CREATE TABLE `tviaje` (
  ...
  `ccliente_ext` varchar(45) default NULL COMMENT 'Si el tipo de viaje es externo se guarda el nombre del cliente de la factura correspondiente al viaje externo',
...
INSERT INTO `tviaje` (`nid_viaje`,`cid_chofer`,`cid_vehiculo`,`dfecha`,`cobservacion`,`cguia`,`corden_carga`,`dfecha_guia`,`npeso_neto`,`cid_usuario`,`dfecha_act`,`nid_origen`,`nid_destino`,`cid_periodo`,`ntipo_viaje`,`nid_sucursal_guia`,`ndistancia`,`nstatus`,`cfactura_ext`,`ccliente_ext`) VALUES 
 (1,'1','V1','2010-07-15',NULL,NULL,NULL,NULL,NULL,'p','2010-07-20 19:30:43',1,2,'15061407',1,1,500,3,' ',''),
 (2,'2','V2','2010-07-15',NULL,NULL,NULL,NULL,NULL,'p','2010-07-20 18:23:25',6,4,'15061407',1,6,1000,2,' ',''),
 ...
 (13,'1','69XPAC','2010-07-21','viaje ext 1',' ',' ','2010-07-21',10000,'P','2010-07-21 19:35:14',1,2,'15061407',2,0,577,0,'1111111111','PEDRO');
...
BEGIN
   ...
   Start Transaction;
      ...
      insert into tviaje (cid_chofer,cid_vehiculo,dfecha,ccliente_ext,cfactura_ext,dfecha_guia,npeso_neto,nid_origen,nid_destino,cid_periodo,ntipo_viaje,cid_usuario,ndistancia,cobservacion)
         values(tcid_chofer,tcid_vehiculo,now(),tccliente_ext,tcfactura_ext,tdfecha_guia,tnpeso_neto,tnid_origen,tnid_destino,tcid_periodo,tntipo_viaje,tcid_usuario,tndistancia,tcobservacion);
...
BEGIN
   ...
   Start Transaction;
      ...
      insert into tviaje (cid_chofer,cid_vehiculo,dfecha,cguia,corden_carga,dfecha_guia,npeso_neto,nid_origen,nid_destino,cid_periodo,ntipo_viaje,nid_sucursal_guia,cid_usuario,ndistancia,cobservacion)
         values(tcid_chofer,tcid_vehiculo,now(),tcguia,tcorden_carga,tdfecha_guia,tnpeso_neto,tnid_origen,tnid_destino,tcid_periodo,tntipo_viaje,tnid_sucursal_guia,tcid_usuario,tndistancia,tcobservacion);
      insert into tanticipo (cnro_recibo,nmonto,nid_viaje,dfecha,cobservacion,cid_usuario)
         values (tcnro_recibo,tnmonto,last_insert_id(),now(),tcobservacion,tcid_usuario);
