...
INSERT INTO `tgrupo_servicio` (`cid_grupo`,`cdescripcion`,`cid_usuario`,`dfecha_act`,`ccta_cont`,`dfecha_add`) VALUES 
 ('01','GRUPO 1','P','2010-02-22 16:21:59','','0000-00-00 00:00:00'),
 ('02','GRUPO 2','P','2010-02-22 16:22:11','','0000-00-00 00:00:00');
...
INSERT INTO `torigen_destino` (`nid_origdest`,`cdescripcion`,`cid_ciudad`,`cid_usuario`,`dfecha_act`,`norigen`,`dfecha_add`) VALUES 
 (18,'ttttttt','0101','p','2010-05-24 15:33:29',1,'0000-00-00 00:00:00'),
 (19,'aaaa','0201','p','2010-05-24 15:47:12',1,'0000-00-00 00:00:00'),
 (20,'Oficina Principal','0101','p','2010-05-24 16:04:31',1,'0000-00-00 00:00:00'),
 (21,'EEE','0101','P','2010-05-25 08:31:11',1,'0000-00-00 00:00:00'),
 (22,'23','0101','P','2010-05-26 15:28:12',1,'0000-00-00 00:00:00');
...
INSERT INTO `tperiodo` (`cid_periodo`,`dfecha_desde`,`dfecha_hasta`,`cdescripcion`,`cid_usuario`,`dfecha_act`,`lstatus`,`dfecha_add`) VALUES 
 ('001','2010-02-24','2010-03-26','FEB-MAR 2010','P','2010-02-24 20:21:42',1,'0000-00-00 00:00:00'),
 ('0123456789','2010-02-24','2010-03-24','PERIODO 1','P','2010-02-24 20:20:40',0,'0000-00-00 00:00:00'),
 ('1','2001-01-01','2001-01-01','AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA','P','2010-02-24 19:39:52',0,'0000-00-00 00:00:00');
...
INSERT INTO `tservicio` (`cid_servicio`,`cdescripcion`,`cid_grupo`,`cid_usuario`,`dfecha_act`,`ccta_cont`,`dfecha_add`) VALUES 
 ('001','SERVICIO 1','01','P','2010-02-22 16:25:21','','0000-00-00 00:00:00'),
 ('002','SERVICIO 2','02','P','2010-02-22 16:25:44','','0000-00-00 00:00:00');
...
CREATE TABLE `tsucursal` (
  ...
  `cid_origdest` varchar(4) NOT NULL,
  `dfecha_add` datetime NOT NULL,
...
INSERT INTO `tsucursal` (`nid_sucursal`,`cdescripcion`,`cid_ciudad`,`cid_usuario`,`dfecha_act`,`ncap_carga`,`cid_origdest`,`dfecha_add`) VALUES 
 (1,'OFICINA PRINCIPAL','1703','P','2010-05-25 08:26:57',1000000,'','0000-00-00 00:00:00'),
 (2,'EEE','0101','P','2010-05-25 08:31:11',20,'','0000-00-00 00:00:00'),
 (3,'23','0101','P','2010-05-26 15:28:12',123,'','0000-00-00 00:00:00');
...
INSERT INTO `ttipo_gasto` (`cid_tipogasto`,`cdescripcion`,`cid_usuario`,`dfecha_act`,`ccta_cont`,`dfecha_add`) VALUES 
 ('01','FFFGFFTTTTTHHHHHHTTTTGGGGGFFF','P','2010-02-09 14:17:06','','0000-00-00 00:00:00'),
 ('02','GGGGGGGGGGGG','P','2010-02-09 11:14:12','','0000-00-00 00:00:00'),
 ('03','SFSDFSDF','P','2010-02-09 11:14:20','','0000-00-00 00:00:00'),
 ('04','GGGGGGG','P','2010-02-09 11:19:58','','0000-00-00 00:00:00'),
 ('05','UUUUUUUUUUUUUUU','P','2010-02-09 11:20:18','','0000-00-00 00:00:00');
