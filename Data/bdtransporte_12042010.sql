...
INSERT INTO `tanticipo_viaje` (`nid_anticipo`,`cnro_recibo`,`cid_chofer`,`cid_vehiculo`,`nmonto`,`dfecha`,`cid_sucursal`,`cid_destino`,`cobservacion`,`cguia`,`corden_carga`,`dfecha_guia`,`npeso_neto`,`cid_usuario`,`dfecha_act`) VALUES 
 (1,'1','15513026','70LOAE',10,'2010-03-23','1','0001','ASDFGHVBCVBdddd\r\nsadasdasdasd','106','7','2008-04-01',0,'P','2010-03-25 10:55:47'),
 (2,'2','12594978','68XPAC',20,'2010-03-23','1','0002','AKJFHKAJSLDFHKLJASDHFLKJSDHFLK\r\nSADFSDAFSDFJH\r\nSADLKJFHKJLSADHFKLJ','1856','2000','2008-07-16',34700,'P','2010-03-24 08:52:14'),
 (7,'1','1','1',1,'2010-03-23','1','1','798765465465\r\n',NULL,'1',NULL,NULL,'P','2010-03-24 08:53:21'),
 (8,'1','1','1',1,'2010-03-23','1','1','aaaaaa',NULL,'1',NULL,NULL,'P','2010-03-23 18:34:13'),
 (9,'1','14760152','12RNAB',1,'2010-03-24','1','0001','','123','123','2008-04-02',30150,'P','2010-03-24 09:27:42'),
 (10,'12','3859684','20FUAB',212,'2010-03-24','1','0002','aaa','119','121','2008-04-02',30150,'P','2010-03-24 14:55:07');
...
INSERT INTO `tchofer` (`cid_chofer`,`cnombre`,`ccta_cont`,`cficha`,`cid_sucursal`,`cid_usuario`,`dfecha_act`,`lcontratado`) VALUES 
 ('12325466','SDFSDFSDF','324234','324234','03','P','2010-02-11 11:06:53',0),
 ('12365658','FFGGGGL','32','234234','01','P','2010-02-11 11:07:16',0),
 ('12594978 ','PEREZ PEREZ, YOELAN ',NULL,NULL,'1 ','root','2010-03-25 11:04:53',1),
 ('15513026 ','ZAVARCE SUAREZ,GETNE',NULL,NULL,'1 ','root','2010-03-25 11:04:24',1),
 ('23132132','1321EFG321DF32G1DF','132132','1','02','P','2010-02-11 15:38:55',0),
 ('3','2RT1312ERT','312','1231','02','P','2010-02-11 15:39:12',0),
 ('321','32E1T','321','321','04','P','2010-02-11 15:39:50',0),
 ('65465465','4','321','321','03','P','2010-02-11 15:40:10',0);
...
INSERT INTO `tsucursal` (`cid_sucursal`,`cdescripcion`,`cid_ciudad`,`cid_usuario`,`dfecha_act`,`ccarpeta`) VALUES 
 ('01','OFICINA PRINCIPAL','1703','P','2010-02-04 11:45:38',''),
 ('02','VALENCIA','0701','P','2010-02-04 16:41:49',''),
 ('03','MARACAIBO','2301','P','2010-02-04 18:12:04',''),
 ('04','CARACAS','2401','P','2010-02-04 19:10:29','');
...
INSERT INTO `tvehiculo` (`cid_vehiculo`,`cdescripcion`,`cmarca`,`cserial_motor`,`cserial_carroc`,`ntara`,`ncapacidad`,`ctipo_vehic`,`cid_chofer`,`cid_sucursal`,`ncosto`,`cid_usuario`,`dfecha_act`,`npropio`) VALUES 
 ('1111111111','111111111111111111111111111111111111111111111111111111111111','111111111111111111111111111111','111111111111111111111111111111','111111111111111111111111111111',11111.11,11111.11,'\"PESADO\"','12325466','02',0,'P','2010-02-22 11:49:22',0),
 ('2378','PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP','PPPPPPPPPPPPPPPPPPPPPPPPPPPPPP','PPPPPPPPPPPPPPPPPPPPPPPPPPPPPP','PPPPPPPPPPPPPPPPPPPPPPPPPPPPPP',99999.99,99999.99,'MEDIANO\"','65465465','03',0,'P','2010-02-22 11:48:46',1),
 ('68XPAC    ','CAMION CHUTO 1999                       ',NULL,NULL,NULL,NULL,NULL,NULL,'12594978 ','1 ',NULL,'root','2010-03-25 11:04:52',0),
 ('70LOAE    ','KODIAT                                  ',NULL,NULL,NULL,NULL,NULL,NULL,'15513026 ','1 ',NULL,'root','2010-03-25 11:04:22',0);
